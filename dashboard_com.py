...
def main():
    ...
    with col_logo:
        # Agregar el logo con padding superior e izquierdo
        ...
        try:
            ...
            if os.path.exists(logo_path):
                ...
                st.markdown("<div style='padding: 10px; text-align: center; color: #999; font-size: 10px;'>Logo no encontrado</div>", unsafe_allow_html=True)
        except Exception as e:
            st.markdown(f"<div style='padding: 10px; text-align: center; color: #999; font-size: 10px;'>Error: {str(e)[:50]}</div>", unsafe_allow_html=True)
